# Generated by Django 3.0.6 on 2020-10-13 15:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investigationFile', models.FileField(blank=True, null=True, upload_to=draft_forms.models.UploadTo('investigationFile'))),
                ('handlingDate', models.CharField(default='', max_length=70)),
                ('findingDate', models.CharField(default='', max_length=70)),
                ('findingFile', models.FileField(blank=True, null=True, upload_to=draft_forms.models.UploadTo('findingFile'))),
                ('handlingFile', models.FileField(blank=True, null=True, upload_to=draft_forms.models.UploadTo('handlingFile'))),
                ('reviewFile', models.FileField(blank=True, null=True, upload_to=draft_forms.models.UploadTo('reviewFile'))),
