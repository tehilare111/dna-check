...
class FormsTable(EventForm):
    ...
    eventDate = models.DateField( blank=False, default='')
    ...
    investigationDate = models.DateField( blank=False, default='')
    ...
    handlingDate =models.DateField( blank=False, default='')
    findingDate = models.DateField( blank=False, default='')
    ...
    reviewDate = models.DateField( blank=False, default='')
